...
if __name__ == "__main__":
    ...
    cosmo_data_path = dpl.load_dataframe(args.cosmo_data_path)
    ...
    site_coordinates = get_site_coordinates(sites, meta)
    clima_cosmo = get_site_cosmo_clima(site_coordinates, 2017, 2017, cosmo_data_path)
