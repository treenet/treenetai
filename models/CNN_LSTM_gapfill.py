...
class CNN_LSTM_gapfill:
    def __init__(
        ...
        **kwargs  # NOTE: allows us to ignore other keywords
        ...
        super(CNN_LSTM_gapfill, self).__init__()
        self.inputs = inputs
    ...
    def make_model(self):
        ...
        x = tf.keras.layers.Dense(n_timesteps * n_features, activation='relu')(x)
        x = tf.keras.layers.Reshape((n_timesteps, n_features))(x)
