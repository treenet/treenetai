...
class TestTCNModel:
    ...
    def test_model_creation_default(self, sample_config):
        ...
        model = TCNModel.build_model(sample_config)
    ...
    def test_model_creation_custom_params(self, sample_config):
        ...
        # Modify config
        sample_config.model.n_filters = 16
        sample_config.model.kernel_size = 5
        sample_config.model.n_layers = 3
        sample_config.model.dropout_rate = 0.3
    ...
    def test_model_input_shapes(self, sample_config):
        ...
        batch_size = 4
        timesteps = sample_config.segment.segment_days * 144
        n_channels = sample_config.model.n_input_channels
    ...
    def test_model_receptive_field(self, sample_config):
        ...
        n_layers = sample_config.model.n_layers
        kernel_size = sample_config.model.kernel_size
        ...
        # For 30-day segments at 10-min (4320 timesteps), we need good coverage
        # Receptive field should be at least several hundred timesteps
        assert receptive_field >= 100, f"Receptive field {receptive_field} too small"
